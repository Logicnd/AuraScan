...
export default function SignupPage() {
  ...
  const handleGitHubSignup = async () => {
    try {
      ...
      setErrorMessage(err.message || 'Failed to sign up with GitHub');
    }
  };
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3 mb-6">
              ...
              <Button
                ...
                className="w-full bg-slate-700 hover:bg-slate-600 text-white flex items-center justify-center gap-3"
              >
                <GitHubIcon />
